...
class Laplacian_transformation_down(torch.nn.Module):
    def __init__(self, level_size,align_corners):
        super(Laplacian_transformation_down, self).__init__()
...
class Laplacian_transformation_grid(torch.nn.Module):
    def __init__(self, level_size,align_corners):
        super(Laplacian_transformation_grid, self).__init__()
        self.pyramid_level = len(level_size)
        self.pyramid_level_size = level_size
        self.align_corners = align_corners
